...
define('BASEPATH'   , IS_LOCAL ? '/DossierApp/' : '____BASEPATH DE PRODUCCIÓN___');
...
define('PORT'       , '');
define('URL'        , IS_LOCAL ? 'http://localhost:'.PORT.'/DossierApp/' : '___URL DE PRODUCCIÓN___');
